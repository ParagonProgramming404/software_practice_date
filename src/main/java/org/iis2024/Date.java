...
=======
  ...
  public Date(int dia, int mes, int año) { this.day = dia;
    this.month = mes; this.year = año;
>>>>>>> c17479dbfc5418ba7104a3b106e6e810abdee106
  }
  public  int Ricardo;
  public void MethodAddedByOwner() {
    System.out.println("Method added by owner (Oskar)");
  }
